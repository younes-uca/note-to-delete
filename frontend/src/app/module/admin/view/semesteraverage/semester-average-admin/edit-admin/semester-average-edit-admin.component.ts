...
@Component({
  ...
  templateUrl: './semester-average-edit-admin.component.html'
})
export class SemesterAverageEditAdminComponent extends AbstractEditController<SemesterAverageDto, SemesterAverageCriteria, SemesterAverageService>   implements OnInit {
