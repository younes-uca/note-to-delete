package  ma.sir.note.ws.facade.admin;
...
import ma.sir.note.ws.converter.TrainingConverter;
import ma.sir.note.ws.dto.TrainingDto;
import ma.sir.note.zynerator.controller.AbstractController;
import ma.sir.note.zynerator.dto.AuditEntityDto;
import ma.sir.note.zynerator.util.PaginatedList;
...
import ma.sir.note.zynerator.process.Result;


import org.springframework.web.multipart.MultipartFile;
import ma.sir.note.zynerator.dto.FileTempDto;
...
public class TrainingRestAdmin  extends AbstractController<Training, TrainingDto, TrainingHistory, TrainingCriteria, TrainingHistoryCriteria, TrainingAdminService, TrainingConverter> {
    ...
    public List<Training> findByStudentId(@PathVariable Long id){
