package ma.sir.note.zynerator.converter;


import ma.sir.note.zynerator.bean.Etablissement;
import ma.sir.note.zynerator.dto.EtablissementDto;

import ma.sir.note.zynerator.util.ListUtil;
import ma.sir.note.zynerator.audit.AuditBusinessObject;
import ma.sir.note.zynerator.bean.BusinessObject;
